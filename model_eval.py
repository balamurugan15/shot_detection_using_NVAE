...
class AutoEncoder(nn.Module):
    ...
    def init_stem(self):
        ...
        Cin = 1 if self.dataset in {'mnist', 'omniglot'} else 3 #do not put knnw here
    ...
    def decoder_output(self, logits):
        if self.dataset in {'mnist', 'omniglot'}:
            return Bernoulli(logits=logits)
                              ...
                              'lsun_bedroom_128', 'lsun_bedroom_256', 'lsun_church_64', 'lsun_church_128', 'knnw'}:  #-------
            if self.num_mix_output == 1:
